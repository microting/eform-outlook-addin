...
var MainComponent = /** @class */ (function () {
    ...
    MainComponent.prototype.onInsert = function () {
        ...
        if (this.state === state_1.CRANEID) {
            ...
            txt_body = 'Template# ' + this.uitext.eform[state_1.CRANEID] + '<br>';
            // crane - ship
            ...
            txt_body = 'Template# ' + this.uitext.eform[state_1.WATERID] + '<br>';
            // water - ship
...
var DataService = /** @class */ (function () {
    function DataService(http, injector, zone) {
        this.http = http;
...
var WaterComponent = /** @class */ (function () {
    ...
    WaterComponent.prototype.getState = function () {
        var _this = this;
        this._state.getWaterState().subscribe(function (ws) {
            _this.zone.run(function () {
                _this.state = ws;
            });
        });
...
module.exports = __webpack_require__(/*! /Users/microting/Documents/workspace/eform-outlook-addin/src/main.server.ts */"./src/main.server.ts");
